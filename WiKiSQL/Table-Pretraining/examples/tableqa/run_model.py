...
def set_train_parser(parser_group):
    ...
    train_parser.add_argument("--save-interval-updates", type=int, default=100,
                              help="the total os")
    train_parser.add_argument("--validate-interval", type=int, default=1000,
                              help="the total os")
...
def train_fairseq_model(args):
    cmd = f"""
        ...
        --log-format json  \
        --log-interval 50  \
        --save-interval-updates	{args.save_interval_updates} \
        --validate-interval	{args.validate_interval} \
        --save-interval	50 \
        --patience 200 \
        --report-accuracy
    """

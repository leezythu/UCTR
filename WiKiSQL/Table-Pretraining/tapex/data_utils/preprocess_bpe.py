...
def fairseq_bpe_translation(data_dir, resource_name, resource_dir=None, with_test_set=True):
    ...
    # assert "syn.src" in data_files, "You should prepare your dataset and guarantee a file named `syn.src`."
    # assert "syn.tgt" in data_files, "You should prepare your dataset and guarantee a file named `syn.tgt`."

...
day="0706"
# syn
# CUDA_VISIBLE_DEVICES=4 PYTHONPATH=src/feverous python src/feverous/baseline/predictor/train_verdict_predictor.py --wiki_path data/feverous_wikiv1.db --model_path models/feverous_verdict_predictor_from_syn_label_3_0527_by_step --input_path syn_data  --pretrained_path roberta-large --sample_nei --num_label 3
...
# mqaqg
# CUDA_VISIBLE_DEVICES=1 PYTHONPATH=src/feverous python src/feverous/baseline/predictor/train_verdict_predictor.py --wiki_path data/feverous_wikiv1.db --model_path models/feverous_verdict_predictor_from_mqaqg_label_3_0527 --input_path mqaqg  --pretrained_path roberta-large --sample_nei --num_label 3
